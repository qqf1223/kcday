...
;(function ($, window, document, undefined) {
	...
	*/
	...
	Tree.prototype._renderNode = function (node, previousNode) {
		...
		//Add opration add/edit/remove button
		...
		node.$el.children('button.fa-plus').on('click',{node:node}, addNode);
		node.$el.children('button.fa-edit').on('click',{node:node}, editNode);
		node.$el.children('button.fa-remove').on('click',{node:node}, removeNode);
	...
	Tree.prototype._template = {
		...
		button: {
			add:$('<button class="btn fa fa-plus pull-right node-hidden"></button>'),
			edit:$('<button class="btn fa fa-edit pull-right node-hidden"></button>'),
			remove:$('<button class="btn fa fa-remove pull-right node-hidden"></button>'),
		}
	};
