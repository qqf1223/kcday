...
<!-- Tab panes -->
<form class="form-horizontal" id="syssetting" action="__URL__/sysSetting" method="post" enctype="multipart/form-data">
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="email">
            <div class="form-group">
                <label class="control-label col-md-2" for="mail_server">邮件服务器:</label>
                <div class="col-md-4">
                    <input id="mail_server" type="text" class="form-control" name="mail_server" value=""  placeholder="smtp.qq.com"/>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-2" for="mail_port">邮件发送端口:</label>
                <div class="col-md-2">
                    <input id="mail_port" type="text" class="form-control" name="mail_port" value="25" />
                </div>
            </div>
            <div class="form-group">
                <label for="mail_from" class="control-label col-md-2">发件人地址:</label>
                <div class="col-md-4">
                    <input id="mail_from " type="text" class="form-control" name="mail_from" value="" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label" for="mail_type">邮件发送模式:</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                <label for="mail_user" class="control-label col-md-2">验证用户名:</label>
                <div class="col-md-4">
                    <input id="mail_user " type="text" class="form-control" name="mail_user" value="" />
                </div>
            </div>
            <div class="form-group">
                <label for="mail_password" class="control-label col-md-2">验证密码:</label>
                <div class="col-md-4">
                    <input id="mail_password " type="text" class="form-control" name="mail_password" value="" />
                </div>
            </div>
            <div class="form-group">
                <label for="mail_to" class="control-label col-md-2">测试邮箱:</label>
                <div class="col-md-4">
        ...
        <div role="tabpanel" class="tab-pane" id="safe">
            <div class="form-group">
                <label class="control-label col-md-2" for="maxloginfailedtimes">后台最大登陆失败次数：</label>
                <div class="col-md-4">
                    <input id="maxloginfailedtimes" type="text" class="form-control" name="maxloginfailedtimes" value="" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-2" for="enablcodecheck">登陆是否开启验证码：</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                <label class="control-label col-md-2" for="allow_file_type">允许上传文件类型：</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                <label class="control-label col-md-2" for="clearcache">清空缓存：</label>
                <div class="col-md-4">
...
<script type="text/javascript" src="{{'js/default/bootstrapSwitch.js'}}"></script>
@stop